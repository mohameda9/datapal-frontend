        ...
        options: {
          ...
          scales: {
            x: {
              ...
              ticks: {
                color: '#FFFFFF'  // Change x-axis tick color to white
              },
              type: 'linear',
              position: 'bottom'
            },
            y: {
              ...
              ticks: {
                color: '#FFFFFF'  // Change y-axis tick color to white
              }
            }
          },
          plugins: {
            ...
            tooltip: {
              ...
              titleColor: '#FFFFFF'  // Change tooltip title text color to white
            }
          }
        }
      });
